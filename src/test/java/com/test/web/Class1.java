...
//		driver.manage().timeouts().pageLoadTimeout(5000, TimeUnit.MILLISECONDS);
	...
	public void test1() throws Exception
	{
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@title='Search']")).sendKeys("Class1 Method1");
		driver.close();
	}
	...
	public void test2() throws Exception
	{
		...
		Thread.sleep(5000);
		driver2.findElement(By.xpath("//*[@title='Search']")).sendKeys("Class1 Method2");
		driver2.close();
	}
	...
	public void test3() throws Exception
	{
		...
		Thread.sleep(5000);
		driver3.findElement(By.xpath("//*[@title='Search']")).sendKeys("Class1 Method3");
		driver3.close();
	}
	...
	public void test4() throws Exception
	{
		...
		driver2.get("https://www.google.co.in");
		Thread.sleep(5000);
		driver2.findElement(By.xpath("//*[@title='Search']")).sendKeys("Class1 Method4");		
	}
